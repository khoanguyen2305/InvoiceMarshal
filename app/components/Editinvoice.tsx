                ...
                <input type="hidden" name={fields.total.name} value={calcualteTotal} />
                        ...
                        <div>
                            ...
                            <div className="flex">
                                ...
                                <Input
                                    ...
                                    className="rounded-l-none" placeholder="123"
                                /> 
                            </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-12 gap-4 mb-4">
                            ...
                            <div className="col-span-2">
                                <Input value={formatCurrency({amount: calcualteTotal, currency: currency as any,})} disabled/>
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-end">
                        <div className="w-1/3">
                            <div className="flex justify-between py-2">
                                <span>SubTotal: </span>
                                <span>{formatCurrency({amount: calcualteTotal, currency: currency as any})}</span>
                            </div>
                            <div className="flex justify-between py-2 border-t">
                                <span>Total ({currency}) </span>
                                <span className="font-medium underline underline-offset-2">{formatCurrency({amount: calcualteTotal, currency: currency as any})}</span>
                            </div>
                        </div>
                    </div>
